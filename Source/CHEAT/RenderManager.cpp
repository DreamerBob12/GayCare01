...
void Render::dwqhfuiwehfuiewgbfrendera()
{
	...
	if (pJunkcode = 784131693)
		pJunkcode = 89308908;
	pJunkcode = 2886622069 + rand() % 99;
	pJunkcode = 2010546483 + rand() % 240;
	if (pJunkcode = 2539730687);
	pJunkcode = 2041915716 + rand() % 15716;
	pJunkcode = 122335422;
...
void Render::Initialise()
{
	...
	Fonts::menushit = Interfaces::Surface->FontCreate();
	dwqhfuiwehfuiewgbfrendera();
	...
	dwqhfuiwehfuiewgbfrendera();
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESP, "Arial", 12, 600, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::otheresp, "Arial", 12, 580, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::indicator, "Arial", 20, 650, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::icons, "Typicons", 18, 500, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW); // "badcache" for icons
	Interfaces::Surface->SetFontGlyphSet(Fonts::menushit, "Verdana", 19, 550, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::Slider, "Verdana", 17, 600, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	...
	sruzrfweiufhuwei();
	Interfaces::Surface->SetFontGlyphSet(Fonts::icons, "Arial", 20, 580, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW); // "badcache"
