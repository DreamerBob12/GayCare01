...
void CCheckBox::Draw(bool hover)
{
	...
	Render::GradientV(a.x, a.y, 14, 14, Color(45, 45, 45, 255), Color(45, 45, 45, 255));
	Render::Outline(a.x, a.y, 14, 14, Color(2, 2, 2, 255));

	if (Checked)
	{
		Render::Clear(a.x, a.y, 14, 14, Color(titler, titleg, titleb, 255));
		Render::Outline(a.x, a.y, 14, 14, Color(2, 2, 2, 255));
	}
}
...
{
	POINT a = GetAbsolutePos();
	Render::Text(a.x, a.y, Color(250, 250, 250, 255), Render::Fonts::MenuBold, Text.c_str());
}
...
void CGroupBox::Draw(bool hover)
{
	...
	box_outlined_text_bordered(abs_pos.x + 13, abs_pos.y + 10, m_iWidth, m_iHeight, 1, Color(255, 255, 255, 255), Color(40, 40, 40, 255), Text.c_str());
}
...
void CSlider::Draw(bool hover)
{
	...
	Render::GradientV(a.x, a.y + 5, m_iWidth, 9, Color(25, 25, 25, 255), Color(25, 25, 25, 255));
	Render::GradientV(a.x, a.y + 5, Location, 9, Color(titler - 5, titleg-5, titleb-5, 255), Color(titler, titleg, titleb, 255));
	Render::Outline(a.x, a.y + 5, m_iWidth, 9, Color(0, 0, 0, 255));


	char buffer[24];
	sprintf_s(buffer, "%.000f", Value);
	RECT txtSize = Render::GetTextSize(Render::Fonts::ESP, buffer);
	Render::Text(a.x + Location - txtSize.right / 2, a.y + 10, Color(200, 200, 200, 255), Render::Fonts::ESP, buffer);
}
...
void CSlider1::Draw(bool hover)
{
	...
	//Draw::Outline(a.x + 1, a.y + 6, m_iWidth - 2, 9, Color(48, 48, 48, GUI.menu_alpha));
	Render::GradientV(a.x, a.y + 5, m_iWidth, 9, Color(150, 5, 250, 255), Color(170, 5, 255, 255));
	Render::Clear(a.x, a.y + 5, Location, 9, Color(titler, titleg, titleb, 255));
...
void CKeyBind::Draw(bool hover)
{
	...
	Render::GradientV(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(40, 40, 40, 255), Color(30, 30, 30, 255));
	Render::Outline(a.x, a.y, m_iWidth, 16, Color(0, 0, 0, 255));
	Render::Outline(a.x + 1, a.y + 1, m_iWidth - 2, 16 - 2, Color(48, 48, 48, 255));
	if (hover)
		Render::GradientV(a.x, a.y, m_iWidth, 16, Color(39, 39, 39, 255), Color(29, 29, 29, 255));
	Render::Outline(a.x, a.y, m_iWidth, 16, Color(0, 0, 0, 255));
	Render::Outline(a.x + 1, a.y + 1, m_iWidth - 2, 16 - 2, Color(48, 48, 48, 255));
...
void CButton::Draw(bool hover)
{
	...
	if (hover)
		Render::GradientV(a.x + 1, a.y + 1, m_iWidth - 2, m_iHeight - 2, Color(20, 20, 20, 255), Color(25, 25, 25, 255));
	else
		Render::GradientV(a.x + 1, a.y + 1, m_iWidth - 2, m_iHeight - 2, Color(25, 25, 25, 255), Color(20, 20, 20, 255));
...
void CComboBox::Draw(bool hover)
{
	...
	Render::GradientV(a.x, a.y, m_iWidth, 16, Color(30, 30, 30, 255), Color(18, 18, 18, 255));
	Render::Outline(a.x, a.y, m_iWidth, 16, Color(0, 0, 0, 255));
	Render::Outline(a.x + 1, a.y + 1, m_iWidth - 2, 16 - 2, Color(48, 48, 48, 255));
	...
	if (GUI.IsMouseInRegion(Region))
		Render::GradientV(a.x, a.y, m_iWidth, 16, Color(30, 30, 30, 255), Color(20, 20, 20, 255));
	Render::Outline(a.x, a.y, m_iWidth, 16, Color(0, 0, 0, 255));
	Render::Outline(a.x + 1, a.y + 1, m_iWidth - 2, 16 - 2, Color(48, 48, 48, 255));
	...
	if (Items.size() > 0)
	{
		...
		if (IsOpen)
		{
			Render::GradientV(a.x, a.y + 17, m_iWidth, Items.size() * 16, Color(30, 30, 30, 255), Color(20, 20, 20, 255));
			Render::Outline(a.x, a.y + 17, m_iWidth, Items.size() * 16, Color(8, 8, 8, 255));
			...
			for (int i = 0; i < Items.size(); i++)
			{
				...
				{
					Render::Text(a.x + 2, a.y + 19 + i * 16, Color(titler, titleg, titleb, 255), Render::Fonts::MenuBold, Items[i].c_str());
				}
				else
				{
...
void CTextField2::Draw(bool hover)
{
	...
	Render::GradientV(a.x, a.y, m_iWidth, m_iHeight, Color(30, 30, 30, 255), Color(20, 20, 20, 255));
	if (hover || IsGettingKey)
		Render::GradientV(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(20, 20, 20, 255), Color(30, 30, 30, 255));
