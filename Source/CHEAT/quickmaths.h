...
namespace Math
{
	...
	extern void VectoreAngles(const Vector&vecForward, Vector&vecAngles);
...
void Math::VectoreAngles(const Vector&vecForward, Vector&vecAngles)
{
	Vector vecView;
	if (vecForward[1] == 0.f && vecForward[0] == 0.f)
	{
